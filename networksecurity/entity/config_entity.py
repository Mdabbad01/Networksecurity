...
class TrainingPipelineConfig:
    def __init__(self, timestamp=datetime.now()):
        ...
        # MODEL DIR points to where final models are stored
...
class ModelTrainerConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.model_params = training_pipeline.MODEL_TRAINER_PARAMS
        self.base_accuracy = training_pipeline.MODEL_TRAINER_BASE_ACCURACY
...
class ModelEvaluationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.model_registry_dir = training_pipeline_config.model_dir
